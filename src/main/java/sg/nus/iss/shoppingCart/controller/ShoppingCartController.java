...
public class ShoppingCartController {
	...
	public ResponseEntity<Object> getShoppingCartPage(HttpSession sessionObj, Model model) {
...
//			}
	...
	public ResponseEntity<Object> updateQuantity(@RequestBody Map<String,Integer> requestBody,
								 RedirectAttributes redirectAttributes,
								 ShoppingCartItem shoppingCartItem,
								 HttpSession sessionObj) {
		int product_id = (int)requestBody.get("product_id");
		...
		if(customerId==null) {
			...
			if(scService.checkIfExistInShoppingCart(product_id,sc)!=null) {
				...
				Map<String,String> errorResponse = new HashMap<>();
				errorResponse.put("ERROR","Can Not Find Product");
				return new ResponseEntity<>(errorResponse,HttpStatus.NOT_FOUND);
			}
		}
	}
	...
	public ResponseEntity<Object> deleteItem(@RequestParam("id") int product_id , HttpSession sessionObj) {
		Integer customerId = (Integer)sessionObj.getAttribute("customerId");
		if(customerId==null) {
			Map<String,String> errorResponse = new HashMap<>();
			errorResponse.put("ERROR","Can Not Get Customer Info");
	...
	public ResponseEntity<Object> addToShoppingCart(HttpSession sessionObj,@RequestParam("id") int product_id) {
		Integer customerId = (Integer)sessionObj.getAttribute("customerId");
		if(customerId == null) {
			Map<String,String> errorResponse = new HashMap<>();
			errorResponse.put("ERROR","Can Not Get Customer Info");
	...
	public ResponseEntity<Object> CheckoutAllInShoppingCart(HttpSession sessionObj,@RequestBody Map<String,Object> requestBody) {
		LocalDate orderDate =LocalDate.parse((String)requestBody.get("order_date"), DateTimeFormatter.ISO_LOCAL_DATE);  

		// get totalPrice turn to BigDecimal whatever it is int or double;
		...
		if(customer == null) {
			...
			for (Map<String,Object> item:products) {
				...
				ShoppingCart sc =scService.getShoppingCart(customer.getId());
				try {
	...
	public ResponseEntity<Object> getCount(HttpSession sessionObj){
		Integer customerId = (Integer)sessionObj.getAttribute("customerId");
		if(customerId==null) {
			Map<String,String> errorResponse = new HashMap<>();
			errorResponse.put("ERROR","Can Not Get Customer Info");
